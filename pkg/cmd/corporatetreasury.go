...
func handleCorporateTreasuryGetLiquidityPositions(ctx context.Context, cmd *cli.Command) error {
	...
	_, err = client.Corporate.Treasury.GetLiquidityPositions(ctx, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(os.Stdout, "corporate:treasury get-liquidity-positions", obj, format, transform)
}
