...
func TestCorporateCardsCreateVirtual(t *testing.T) {
	...
	mocktest.TestRunMockTestWithFlags(
		t,
		"corporate:cards", "create-virtual",
		"--controls.atm-withdrawals=false",
		"--controls.contactless-payments=false",
		"--controls.daily-limit", "500",
		"--controls.international-transactions=false",
		"--controls.merchant-category-restrictions", "[Advertising]",
		"--controls.monthly-limit", "1000",
		"--controls.online-transactions=true",
		"--controls.single-transaction-limit", "200",
		"--controls.vendor-restrictions", "[Facebook Ads, Google Ads]",
		"--expiration-date", "2025-12-31",
		"--holder-name", "Marketing Campaign Q4",
		"--purpose", "Online advertising for Q4 campaigns",
		"--associated-employee-id", "emp_marketing_01",
