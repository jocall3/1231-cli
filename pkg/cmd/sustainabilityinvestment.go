...
func handleSustainabilityInvestmentsAnalyzeImpact(ctx context.Context, cmd *cli.Command) error {
	...
	_, err = client.Sustainability.Investments.AnalyzeImpact(ctx, options...)
	if err != nil {
		return err
	}
	...
	return ShowJSON(os.Stdout, "sustainability:investments analyze-impact", obj, format, transform)
}
